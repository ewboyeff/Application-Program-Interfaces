          ...
          <div className="mt-8 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative">
              ...
              <span className="absolute left-5 top-5 inline-flex items-center gap-1.5 rounded-full border border-primary/40 bg-background/70 px-3 py-1.5 text-[10px] uppercase tracking-[0.22em] text-primary backdrop-blur-md">
                ...
                Muzeydan ilhomlangan
              </span>
            </div>

            {/* Info */}
            <div>
              <p className="eyebrow">— {product.museum}</p>
              ...
              <div className="mt-10 flex flex-wrap items-center gap-4">
                ...
                <button
                  onClick={() => {
                    ...
                    toast(liked ? "Sevimlilardan olib tashlandi" : "Sevimlilarga qo'shildi");
                  }}
              ...
              <div className="mt-12 grid grid-cols-1 gap-3 sm:grid-cols-3">
                {[
                  { Icon: Award, label: "Sertifikatlangan asl" },
                  { Icon: Truck, label: "Bepul yetkazib berish" },
                  { Icon: ShieldCheck, label: "14 kun qaytarish" },
                ].map(({ Icon, label }) => (
                  <div
                    key={label}
      ...
      <section className="bg-background pb-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="mb-10 flex items-end justify-between">
            <div>
              <p className="eyebrow">— O'xshash</p>
              <h2 className="mt-3 font-serif text-3xl sm:text-4xl">
                Sizga <span className="italic text-primary">yoqishi mumkin</span>
              </h2>
            </div>
          </div>
